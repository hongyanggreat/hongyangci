                        ...
                        <tbody>
                           ...
                           ?>
                            <tr class="even gradeC" align="center">
                                ...
                                <td ><img width="90px" src="<?php echo $image ?>" alt="" title="<?php echo $item->image ?>"></td>
                                <?php if($item->status == 1 && $item->catagory != 0){

                                 ?>
                                 <td><a href="<?php echo base_url($item->id.'-'.changTitle($item->title).'.htm') ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                               <?php }else{ ?>
                                <td><a href="#" ><i class="fa fa-eye-slash" aria-hidden="true" style="color:red"></i></a></td>
