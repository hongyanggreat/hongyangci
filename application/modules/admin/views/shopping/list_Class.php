 ...
 <button class="btn btn-success" onclick="add_class()"><i class="glyphicon glyphicon-plus"></i> Add Class Product</button>
...
var table;
    table = $('#table').DataTable({ 
       ...
       "processing": true, //Feature control the processing indicator.
        "ajax": {
            "url": "<?php echo site_url('admin/shopping/ClassProduct/ajaxlist')?>",
            "type": "POST"
        },
    ...
    function add_class()
        {
            ...
            $('.modal-title').text('Add Class Product'); // Set Title to Bootstrap modal title
        }
    ...
    function edit_class(id)
        {
            ...
            $.ajax({
                url : "<?php echo site_url('admin/shopping/ClassProduct/ajax_edit/')?>/" + id,
                type: "GET",
                dataType: "JSON",
                ...
                {   
                    ...
                    $('[name="cat_menu"]').val(data.cate_product);
                    $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
                    $('.modal-title').text('Edit Class Product'); // Set title to Bootstrap modal title
    ...
    function save()
        {
            ...
            if(save_method == 'add') {
                url = "<?php echo site_url('admin/shopping/ClassProduct/ajax_add')?>";
            } else {
                url = "<?php echo site_url('admin/shopping/ClassProduct/ajax_update')?>";
            }
        ...
        function delete_class(id)
        {
          if(confirm('Are you sure delete this data?')){
            var url = "<?php echo site_url('admin/shopping/ClassProduct/ajax_delete')?>/"+id;
            $.ajax({
                 url : url,
                type: "POST",
                dataType: "JSON",
        ...
        function filter_status(id,status){
            var url = "<?php echo site_url('admin/shopping/ClassProduct/ajax_filter')?>/"+id+"/"+status;
                 $.ajax({
                    url : url,
                    type: "POST",
                    dataType: "JSON",
        ...
        var status = $(this).val();
           if(status != ''){
                var url = "<?php echo site_url('admin/shopping/ClassProduct/ajaxStatus')?>/"+status;
              //  alert(url);
                 $.ajax({
                    url : url,
                    type: "POST",
            ...
            <div class="modal-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="cat_menu" id="cat_menu">
                                <option value="">Please Choose Cate</option>
                                    <?php 
