<div id="blog-wrap" class="clr">
        <article class="archive-featured-post clr">
            ...
            <div class="archive-featured-post-content clr">
                ...
                <a href="<?php echo base_url('/').$oneArticle->alias ?>" title="<?php echo $oneArticle->title ?>"><?php echo $oneArticle->id.  $oneArticle->title?></a>
            </h2> </header>
        ...
        <a href="<?php echo base_url('/').$item->alias ?>" title="<?php echo $item->title ?>"> <?php echo $item->id.  substr($item->title,0,30) ?> ...</a>
    </h2> </header>
    ...
    <div class="row-remove">
        <button class="btn btn-success" id="see-more-category" data-limit="<?php echo $limit ?>" data-id="<?php echo $item->id ?>" data-id-one="<?php echo $oneArticle->id ?>" data-category="<?php echo $category->id ?>">Load data</button>
    </div>
