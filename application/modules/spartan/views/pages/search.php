			<header class="archive-header clr">
				<h1 class="archive-header-title">Search Results for: <?php echo $keyword ?></h1>
            <?php echo $paginator ?>
            </header>
...
<?php 
    foreach ($listArticleSearch as $item) {
?>					
...
<div class="loop-entry-meta clr">
                    ...
                    <span class="fa fa-eye"></span><a href="http://wpexplorer-demos.com/spartan/formula-1-is-boring/#comments" class="comments-link"><?php echo number_format($item->view,'0',',','.') ?> View</a>                </div>
                    </div><!-- .loop-entry-meta -->     
